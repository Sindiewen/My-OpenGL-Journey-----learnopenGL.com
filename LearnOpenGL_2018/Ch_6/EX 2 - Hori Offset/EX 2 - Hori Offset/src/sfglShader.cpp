...
void sfglShader::definesShaderUniform()
{
	...
	*/
	...
	// Horizontal Shift via Uniform
	int horiShiftLocation = glGetUniformLocation(ShaderProgram, "horiShift");
	float timeValue = glfwGetTime();
	float shiftVal = sin(timeValue + 2.0f) * 0.5f;
	glUniform3f(horiShiftLocation, 0.0f, 0.0f, 0.0f);
}
